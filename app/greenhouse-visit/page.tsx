                ...
                {open && (
                    ...
                    >
                        <div className="flex items-start justify-between mb-2">
                            <div>
                                <h3 className="text-sm font-semibold text-gray-900 dark:text-white">Greenhouse Facility Visit</h3>
            ...
            if (match) {
                try {
                    ...
                    await fetch('/api/register', {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
                        body: JSON.stringify({ ...parsed, email: '' }) // Send empty email as it's optional
                    });
